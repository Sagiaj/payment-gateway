<template>
  <div class="card-form">
    <!-- <div style="display: inline-block;" class="d-none" :id="`${hostedFieldsContainers.cardNumber}`">{{ formData.cardNumber }}</div> -->
    <!-- <div style="display: inline-block;" class="d-none" :id="`${hostedFieldsContainers.cardYear}`">{{ formData.year }}</div> -->
    <!-- <div style="display: inline-block;" class="d-none" :id="`${hostedFieldsContainers.cardMonth}`">{{ formData.month }}</div> -->
    <!-- <div style="display: inline-block;" class="d-none" :id="`${hostedFieldsContainers.cardName}`">{{ formData.cardName }}</div> -->
    <!-- <div style="display: inline-block;" class="d-none" :id="`${hostedFieldsContainers.cardCvv}`">{{ formData.cardCvv }}</div> -->
    <div class="card-list">
      <Card
        :fields="fields"
        :labels="formData"
    ...
    <div class="card-form__inner">
      ...
      <button class="card-form__button" v-on:click="validateCardNumber">{{ cardForm.submit }}</button>
    </div>
  </div>
</template>
